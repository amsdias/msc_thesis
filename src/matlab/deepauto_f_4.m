...
for iter = 1:1
    ...
    save('saved_variables/vh_f_4l', 'vishidL', 'vishidR', 'hidrecbiasesL', 'hidrecbiasesR', 'visbiasesL', 'visbiasesR');
    ...
    save('saved_variables/hp_f_4l', 'hidpenL', 'hidpenR', 'penrecbiasesL', 'penrecbiasesR', 'hidgenbiasesL', 'hidgenbiasesR');
    ...
    save('saved_variables/hp2_f_4l', 'hidpen2L', 'hidpen2R', 'penrecbiases2L', 'penrecbiases2R', 'hidgenbiases2L', 'hidgenbiases2R');
    ...
    save('saved_variables/po_f_4l', 'hidtopL', 'hidtopR', 'toprecbiasesL', 'toprecbiasesR', 'topgenbiasesL', 'topgenbiasesR');
