...
load ('saved_variables/vh_f_4l.mat')
load ('saved_variables/hp_f_4l.mat')
load ('saved_variables/hp2_f_4l.mat')
load ('saved_variables/po_f_4l.mat')
...
%%%%%%%%%%%%%%% END OF CONJUGATE GRADIENT WITH 3 LINESEARCHES %%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  %save mnist_weights w1L w1R w2L w2R w3L w3R w4L w4R w5L w5R w6L w6R w7L w7R w8L w8R 
  %save mnist_error test_err train_err;
  save(['saved_variables/weights_f_4l_' num2str(iter)], 'w1L', 'w1R', 'w2L', 'w2R', 'w3L', 'w3R', 'w4L', 'w4R', 'w5L', 'w5R', 'w6L', 'w6R', 'w7L', 'w7R', 'w8L', 'w8R');  
  save(['saved_variables/error_f_4l_' num2str(iter)], 'test_err', 'train_err');
