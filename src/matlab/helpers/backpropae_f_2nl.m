...
load ('saved_variables/vh_f_2.mat')
load ('saved_variables/po_f_2.mat')
...
%%%%%%%%%%%%%%% END OF CONJUGATE GRADIENT WITH 3 LINESEARCHES %%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  save(['saved_variables/weights_f_2_' num2str(iter)], 'w1L', 'w1R', 'w2L', 'w2R', 'w3L', 'w3R', 'w4L', 'w4R');  
  save(['saved_variables/error_f_2_' num2str(iter)], 'test_err', 'train_err');
