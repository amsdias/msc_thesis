...
load ('saved_variables/vh_f_3l.mat')
load ('saved_variables/hp_f_3l.mat')
load ('saved_variables/po_f_3l.mat')
...
%%%%%%%%%%%%%%% PERFORM CONJUGATE GRADIENT WITH 3 LINESEARCHES %%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  [XL, XR, fX] = minimizef(VVL, VVR, 'CG__AE_f_3', max_iter, Dim, data);
...
%%%%%%%%%%%%%%% END OF CONJUGATE GRADIENT WITH 3 LINESEARCHES %%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  save(['saved_variables/weights_f_3l_' num2str(iter)], 'w1L', 'w1R', 'w2L', 'w2R', 'w3L', 'w3R', 'w4L', 'w4R', 'w5L', 'w5R', 'w6L', 'w6R');  
  save(['saved_variables/error_f_3l_' num2str(iter)], 'test_err', 'train_err');
