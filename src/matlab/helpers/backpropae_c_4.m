...
load ('saved_variables/vh_c_4.mat')
load ('saved_variables/hp_c_4.mat')
load ('saved_variables/hp2_c_4.mat')
load ('saved_variables/po_c_4.mat')
...
%%%%%%%%%%%%%%% PERFORM CONJUGATE GRADIENT WITH 3 LINESEARCHES %%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  [X, fX] = minimize(VV,'CG_AE_c_4',max_iter,Dim,data);
...
%%%%%%%%%%%%%%% END OF CONJUGATE GRADIENT WITH 3 LINESEARCHES %%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 ...
 %save mnist_weights4c w1 w2 w3 w4 w5 w6 w7 w8 
 %save mnist_error4c test_err train_err;
 save(['saved_variables/weights_c_4_' num2str(iter)], 'w1', 'w2', 'w3', 'w4', 'w5', 'w6', 'w7', 'w8');
 save(['saved_variables/error_c_4_' num2str(iter)], 'test_err', 'train_err');
