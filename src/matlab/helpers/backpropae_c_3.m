...
load ('saved_variables/vh_c_3.mat')
load ('saved_variables/hp_c_3.mat')
load ('saved_variables/hp2_c_3.mat')
...
%%%%%%%%%%%%%%% PERFORM CONJUGATE GRADIENT WITH 3 LINESEARCHES %%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  max_iter=3;
  VV = [w1(:)' w2(:)' w3(:)' w4(:)' w5(:)' w6(:)']';
  Dim = [l1; l2; l3; l4; l5; l6; l7;];

  [X, fX] = minimize(VV,'CG_AE_c_3',max_iter,Dim,data);
...
%%%%%%%%%%%%%%% END OF CONJUGATE GRADIENT WITH 3 LINESEARCHES %%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 ...
 %save mnist_weights3c w1 w2 w3 w4 w5 w6 
 %save mnist_error3c test_err train_err;
 save(['saved_variables/weights_c_3_' num2str(iter)], 'w1', 'w2', 'w3', 'w4', 'w5', 'w6');
 save(['saved_variables/error_c_3_' num2str(iter)], 'test_err', 'train_err');
