...
%%%%%%%%%%%%%%%% END OF UPDATES %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
  ...
  fprintf(1, '### Error Sum (Left)    %6.10f, Epoch Error (Left)    %6.10f ###\n', errsumL, errL);
  fprintf(1, '### Error Sum (Right)   %6.10f, Epoch Error (Right)   %6.10f ###\n', errsumR, errR);
  errors    = [errors error];
  errorsums = [errorsums errorsum];
  %w = waitforbuttonpress;
end
save(['saved_variables/errors_f5_' num2str(numdims) '-' num2str(numhid)], 'errors');
