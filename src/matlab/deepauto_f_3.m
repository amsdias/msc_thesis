...
numhid = 100; numpen = 50; numopen = 20;
...
save('saved_variables/vh_f_3l', 'vishidL', 'vishidR', 'hidrecbiasesL', 'hidrecbiasesR', 'visbiasesL', 'visbiasesR');
...
save('saved_variables/hp_f_3l', 'hidpenL', 'hidpenR', 'penrecbiasesL', 'penrecbiasesR', 'hidgenbiasesL', 'hidgenbiasesR');
...
save('saved_variables/po_f_3l', 'hidtopL', 'hidtopR', 'toprecbiasesL', 'toprecbiasesR', 'topgenbiasesL', 'topgenbiasesR');
