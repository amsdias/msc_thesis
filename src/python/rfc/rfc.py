...
if __name__ == '__main__':
    ...
    model = RandomForestClassifier(n_estimators = 100, verbose=True, n_jobs=-1)
    ...
    for x in range(30):
        ...
        print(y_test.ravel())
        average_auc = plot_multiclass_roc(predictions_score, X_test, y_test, n_classes=7, figsize=(16, 10))
